...
/*
 * Copyright 1995-2004 Sun Microsystems, Inc. All Rights Reserved. DO NOT ALTER OR REMOVE COPYRIGHT
 ...
 * encoded into text by a character encoder, back into original binary form. The
 * character encoders, in general, have been structured around a central theme
 * that binary data can be encoded into text that has the form:
 * 
 * <pre>
 *      [Buffer Prefix]
 ...
 * 'atom' and the binary data itself. In the CharacterEncoder and
 * CharacterDecoder classes, one complete chunk of data is referred to as a
 * <i>buffer</i>. Encoded buffers are all text, and decoded buffers (sometimes
 * just referred to as buffers) are binary octets. To create a custom decoder,
 * you must, at a minimum, overide three abstract methods in this class.
 * <DL>
